...
import { ItemType, Page } from "@/app/types";
  ...
  const handleItemChange = (
    ...
    switch (field) {
      case "id":
        ...
        console.log(updatedItems[index][field], "HERE");
        break;
        case "name":
          updatedItems[index][field] = value as string;
          break;
      ...
      <div className="bg-white rounded-md w-full p-4">
        ...
        <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-4">
                ...
                <div className="files w-full">
                <label className="text-sm font-semibold items-center" htmlFor="files">Quantity<span className="ml-2 text-red-600">*</span></label>
                    <Input
                        type="number"
                        placeholder="0"
                        value={item.quantity}
