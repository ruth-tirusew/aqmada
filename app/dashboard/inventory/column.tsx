      ...
      return (
        <div className="flex space-x-2">
          {/* <Link href={`/inventory/edit/${item.id}`}>
            <Button variant="ghost" size="sm" className="rounded-full bg-white/90 px-2 py-2 text-blue-400 transition hover:text-blue-500">
                <TbPencil className="h-4 w-4  cursor-pointer"/>
              </Button>
            </Link> */}
          <AlertDialog>
