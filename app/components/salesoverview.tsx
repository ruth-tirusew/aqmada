...
const SalesOverview: React.FC<SalesOverviewProps> = ({ items }) => {
    ...
    {chartData.series.length === 0 || loading || totalSales === 0 ? (
      ...
      <div className="flex flex-row justify-between w-full h-full mt-2">
        <div className="flex flex-col items-left gap-4 w-full">
          <p className="text-red-400 font-semibold text-sm mr-2 mb-4">Low Stock Items</p>
          <p className="font-semibold text-sm mr-2">Total Items</p>
        </div>
