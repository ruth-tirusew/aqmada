                        ...
                        <TableCell>
                          <div className="grid grid-cols-2 gap-4">
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              checked={item.permission.includes(PermissionEnum.CREATE)}
                              ...
                              <input
                                 ...
                                 checked={item.permission.includes(PermissionEnum.UPDATE)}
                              ...
                              <input
                                  ...
                                  checked={item.permission.includes(PermissionEnum.DELETE)}
                                  onChange={(isChecked) =>
