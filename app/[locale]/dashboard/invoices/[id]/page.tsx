    ...
    <div className="">
      ...
      <div className="flex gap-4 print:w-full">
        ...
        <div className="w-[30%] p-4 flex flex-col gap-4 print:hidden">
          <button
            className="flex items-center border-2 gap-1 rounded-sm border-[#1C40CA] font-medium text-[#1C40CA] text-md px-6 py-2 hover:bg-gray-200/[30%] text-center px-10"
            onClick={() => {
              handlePrint();
            }}
          >
          ...
          onClick={
            () => {
              window.location.href = `/dashboard/invoice/${routeParam?.id}/edit`;
            }
          }
          >
