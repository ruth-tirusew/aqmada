          ...
          <p className="font-bold text-xl">Welcome back,</p> 
            ...
            <div className="">
              ...
              <div className="email ">
                ...
                <input
                  type="text"
                  className="block rounded-md border-0 py-1.5 pl-7 pr-28 w-full text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#003949] sm:text-sm sm:leading-6"
